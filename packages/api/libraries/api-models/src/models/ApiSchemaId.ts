...
export enum ApiSchemaId {
  ...
  CodeAuthCreateQueryV1 = 'https://onegame.schemas/api/v1/auth/code-auth-create-query.json',
  ...
  EmailPasswordAuthCreateQueryV1 = 'https://onegame.schemas/api/v1/auth/email-password-auth-create-query.json',
