...
describe(useGetGamesV1Mine.name, () => {
  describe('when called, and getGamesV1Mine() returns a UseGetGamesV1MineResult with 200 HTTP status code', () => {
  ...
  describe('when called, and getGamesV1Mine() returns a UseGetGamesV1MineResult with 400 HTTP status code', () => {
    let getGamesV1MineArgsFixture: GetGamesV1MineArgs;
    let subscriptionOptionsFixture: UseQuerySubscriptionOptions;
    let getGamesV1MineResultFixture: Either<
      SerializableAppError | SerializedError,
    ...
    it('should return UseGetGamesV1MineResult with contract violation message', () => {
      const expectedResult: UseGetGamesV1MineResult = {
        result: getGamesV1MineResultFixture,
      };
  ...
  describe('when called, and getGamesV1Mine() returns a UseGetGamesV1MineResult with 401 HTTP status code', () => {
    let getGamesV1MineArgsFixture: GetGamesV1MineArgs;
    let subscriptionOptionsFixture: UseQuerySubscriptionOptions;
    let getGamesV1MineResultFixture: Either<
      SerializableAppError | SerializedError,
    ...
    it('should return UseGetGamesV1MineResult with missing credentials message', () => {
      const expectedResult: UseGetGamesV1MineResult = {
        result: getGamesV1MineResultFixture,
      };
