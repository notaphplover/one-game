...
@Controller('v1/users')
export class GetV1UsersUserIdHttpRequestNestController extends HttpNestFastifyController<Request> {
  constructor(
    @Inject(RequestFromFastifyRequestBuilder)
    requestBuilder: Builder<Request, [FastifyRequest]>,
    @Inject(GetV1UsersUserIdHttpRequestController)
  ...
  @Get(`:${GetV1UsersUserIdRequestParamHandler.userIdRequestParam}`)
