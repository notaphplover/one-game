...
export class GetV1GamesGameIdSlotSlotIdCardsRequestNestController extends HttpNestFastifyController<Request> {
  constructor(
    @Inject(RequestFromFastifyRequestBuilder)
    requestBuilder: Builder<Request, [FastifyRequest]>,
    @Inject(GetV1GamesGameIdSlotSlotIdCardsRequestController)
  ...
  @Get(
    `:${GetV1GamesGameIdSlotSlotIdCardsRequestParamHandler.getGameGameIdSlotSlotIdRequestParam}/cards`,
  )
