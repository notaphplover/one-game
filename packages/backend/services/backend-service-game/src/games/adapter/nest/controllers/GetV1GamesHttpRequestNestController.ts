...
import { GetV1GamesHttpRequestController } from '@cornie-js/backend-game-application/games';
import {
...
@Controller('v1/games')
export class GetV1GamesHttpRequestNestController extends HttpNestFastifyController<Request> {
  constructor(
    @Inject(RequestFromFastifyRequestBuilder)
    requestBuilder: Builder<Request, [FastifyRequest]>,
    @Inject(GetV1GamesHttpRequestController)
