...
import { PostV1GamesGameIdSlotsHttpRequestController } from '@cornie-js/backend-game-application/games';
import {
...
export class PostV1GamesIdSlotHttpRequestNestController extends HttpNestFastifyController<RequestWithBody> {
  constructor(
    @Inject(RequestWithBodyFromFastifyRequestBuilder)
    requestBuilder: Builder<RequestWithBody, [FastifyRequest]>,
    @Inject(PostV1GamesGameIdSlotsHttpRequestController)
