...
import { GetGamesV1HttpRequestController } from '@cornie-js/backend-game-application/games';
import {
...
@Controller('v1/games')
export class GetGamesV1HttpRequestNestController extends HttpNestFastifyController<Request> {
  constructor(
    @Inject(RequestFromFastifyRequestBuilder)
    requestBuilder: Builder<Request, [FastifyRequest]>,
    @Inject(GetGamesV1HttpRequestController)
