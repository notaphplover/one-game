...
@Controller(
  `v1/games/:${GetV1GamesGameIdRequestParamHandler.getGameV1GameIdRequestParam}`,
)
export class GetV1GamesGameIdSpecHttpRequestNestController extends HttpNestFastifyController<Request> {
  constructor(
    @Inject(RequestFromFastifyRequestBuilder)
    requestBuilder: Builder<Request, [FastifyRequest]>,
    @Inject(GetV1GamesGameIdSpecHttpRequestController)
