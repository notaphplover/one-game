...
export class AddGame1679232270610 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "GameSlot" ("cards" json, "id" character varying(36) NOT NULL, "position" smallint, "user_id" character varying(36) NOT NULL, "game_id" character varying(36), CONSTRAINT "game_slot_game_id_position_key" UNIQUE ("game_id", "position"), CONSTRAINT "PK_cdf9b59803dffd6fbf169931fb4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
