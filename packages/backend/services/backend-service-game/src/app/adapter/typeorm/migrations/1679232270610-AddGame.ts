...
export class AddGame1679232270610 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Game" ("active" smallint NOT NULL, "current_card" bit(16), "current_color" bit(16), "current_playing_slot" smallint, "id" character varying(36) NOT NULL, "specs" json, CONSTRAINT "PK_cce0ee17147c1830d09c19d4d56" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
