  ...
  beforeAll(async () => {
    ...
    const datasourceOptions: DataSourceOptions = {
      database: path.resolve(
        'tmp',
        'typeorm',
        'FindTypeOrmQueryBuilderService.sqlite',
      ),
      entities: [ModelTest],
      logging: false,
      type: 'sqlite',
    ...
    describe('.findOne', () => {
      describe('when called, and findQueryTypeOrmFromQueryBuilder.build returns a query builder matching a ModelTest', () => {
        ...
        beforeAll(async () => {
          ...
          result = await findTypeOrmQueryBuilderService.findOne(queryTest);
        });
    ...
    describe('.find', () => {
      describe('when called, and findQueryTypeOrmFromQueryBuilder.build returns a query builder matching a ModelTest', () => {
        ...
        beforeAll(async () => {
          ...
          result = await findTypeOrmQueryBuilderService.find(queryTest);
        });
