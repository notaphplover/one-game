...
import { DeleteUserV1MeRequestParamHandler } from './DeleteUserV1MeRequestParamHandler';

describe(DeleteUserV1MeRequestParamHandler.name, () => {
  let deleteUserV1MeRequestParamHandler: DeleteUserV1MeRequestParamHandler;

  beforeAll(() => {
    deleteUserV1MeRequestParamHandler = new DeleteUserV1MeRequestParamHandler();
  });
