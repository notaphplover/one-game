...
import { PatchV1UsersMeRequestParamHandler } from './PatchV1UsersMeRequestParamHandler';

describe(PatchV1UsersMeRequestParamHandler.name, () => {
  let patchUserMeV1RequestBodyParamHandlerMock: jest.Mocked<
    Handler<[RequestWithBody], [apiModels.UserMeUpdateQueryV1]>
  >;

  let patchUserV1MeRequestParamHandler: PatchV1UsersMeRequestParamHandler;
  ...
  beforeAll(() => {
    ...
    patchUserV1MeRequestParamHandler = new PatchV1UsersMeRequestParamHandler(
      patchUserMeV1RequestBodyParamHandlerMock,
    );
  });
