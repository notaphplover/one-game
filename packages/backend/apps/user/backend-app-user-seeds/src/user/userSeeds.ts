...
export const user1CreateQuery: DeepPartial<UserDb> = {
  email: 'mail-cb483108-fffb-4043-8168-cca05810ec8d@example.com',
...
export const user2CreateQuery: DeepPartial<UserDb> = {
  email: 'mail-9b5e70cf-ed12-44d1-b9c5-44b1746fd16b@example.com',
...
export const user3CreateQuery: DeepPartial<UserDb> = {
  email: 'mail-f605e199-e186-4aff-bc9b-56a3ef8dc7e3@example.com',
...
export const user4CreateQuery: DeepPartial<UserDb> = {
  email: 'mail-32d9b9a6-d98b-4cee-884c-7cf35a7650e5@example.com',
