...
export class AddGame1687721528831 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Game" ("active" smallint NOT NULL, "current_card" bit(16), "current_color" bit(16), "current_direction" character varying(32), "current_playing_slot" smallint, "current_turn_cards_played" smallint, "deck" json NOT NULL, "draw_count" smallint, "id" character varying(36) NOT NULL, "game_slots_amount" smallint NOT NULL, "spec" json NOT NULL, CONSTRAINT "PK_cce0ee17147c1830d09c19d4d56" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
